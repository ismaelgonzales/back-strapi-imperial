...
export interface ApiLandingLanding extends Struct.SingleTypeSchema {
  ...
  attributes: {
    carruselImagen: Schema.Attribute.Media<'files' | 'images', true> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion1: Schema.Attribute.Blocks & Schema.Attribute.Required;
    descripcion2: Schema.Attribute.Blocks & Schema.Attribute.Required;
